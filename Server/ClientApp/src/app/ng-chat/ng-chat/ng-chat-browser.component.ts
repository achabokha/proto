...
@Component({
    selector: 'ng-chat-browser',
    templateUrl: 'ng-chat-browser.component.html',
    styleUrls: [
        'assets/icons.css',
        'assets/loading-spinner.css',
        'assets/ng-chat-browser.component.default.css',
        'assets/themes/ng-chat-browser.theme.default.scss',
        'assets/themes/ng-chat-browser.theme.dark.scss'
    ],
    encapsulation: ViewEncapsulation.None
})

export class NgChatBrowser implements OnInit, IChatController {
