...
namespace Embily.Models.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateSequence(
                name: "UserNumbers",
                startValue: 1000001009L);

            migrationBuilder.CreateTable(
                name: "Configurations",
                columns: table => new
                {
                    ConfigurationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserNumber = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "NEXT VALUE FOR UserNumbers")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getutcdate()"),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProviderAccountNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CryptoAddressId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AccountId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoAddresses", x => x.CryptoAddressId);
                    table.ForeignKey(
                        name: "FK_CryptoAddresses_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CryptoProvider = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CryptoTxnId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getutcdate()"),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DestinationAmount = table.Column<double>(type: "float", nullable: false),
                    DestinationCurrencyCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExchangeFee = table.Column<double>(type: "float", nullable: false),
                    IsAmountKnown = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    TransactionNumber = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEXT VALUE FOR TransactionNumbers"),
                    TxnCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingTrackingNum = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CryptoAddresses_AccountId",
