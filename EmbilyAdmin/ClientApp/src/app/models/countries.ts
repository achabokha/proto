export class Countries {
    public static list: any[] = [
        ...
        { name: "Palau", iso3: "PLW" },
        { name: "Palestine, State of", iso3: "PSE" },
        ...
        { name: "Saint Martin (French part)", iso3: "MAF" },
        ...
        { name: "Sint Maarten (Dutch part)", iso3: "SXM" },
        ...
        { name: "United Kingdom of Great Britain and Northern Ireland", iso3: "GBR" },
